# Scope: Implementation Track (Gen 2 Replacement)
...
| IMP-M2 | Scraper Manager & DB Integration | Integrate `nofluffjobs` into `scraperManager.ts`, manage location mapping, SQLite saving, duplicates prevention. | IMP-M1 | IN_PROGRESS (Explorers: db2a9b90, b326c2b0, f0ef8c3d) |
